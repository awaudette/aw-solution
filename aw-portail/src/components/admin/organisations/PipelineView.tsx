...
import type { StaffMember, OrganisationUpdateInput, NewOrganisationInput, NewContactInput } from "@/hooks/useOrganisations";
...
/** Vue kanban du pipeline — extraite de l'ancienne page pour cohabiter avec les autres vues sous un même jeu d'onglets. */
export function PipelineView({
  organisations, staff, myUid, me, updateOrganisation, createOrganisation, createContact,
}: {
  ...
  createOrganisation: (input: NewOrganisationInput) => Promise<string>;
  createContact: (orgId: string, input: NewContactInput) => Promise<void>;
}) {
  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <p className="text-sm text-gray-500">Glissez les cartes pour faire avancer un dossier.</p>
        <button
