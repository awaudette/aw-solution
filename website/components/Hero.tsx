...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ display: "flex", flexDirection: "column", gap: "1.75rem", width: "100%", maxWidth: 600 }}>

          {/* Badge */}
          <motion.div {...fadeUp(0.2)} style={{ display: "inline-flex" }}>
            <div
              style={{
                display: "flex",
                alignItems: "center",
            ...
            {(() => {
              ...
              return TITLE_LINES.map((line, li) => (
                <span key={li} style={{ display: "block" }}>
                  {line.map((word) => {
                    const delay = 0.4 + wordIndex++ * 0.08;
                    return word.accent ? (
                      <motion.span
                        key={word.text}
                        {...fadeUp(delay)}
          ...
          <motion.div {...fadeUp(1.0)}>
            <Link href="/demo" className="block lg:inline-block" style={{ textDecoration: "none" }}>
              <button
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.boxShadow = "0 0 28px rgba(3,98,227,0.55), 0 0 70px rgba(3,98,227,0.25)";
                }}
                onMouseLeave={(e) => {
